...
public class InterventionRestControllerTest {
	...
	public void getAll() {
		...
		try {
			this.mockMvc.perform(get("/intervention/getAllIntervention").contentType("application/json")).andExpect(status().isOk());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void post() throws Exception {
	    ...
	    this.mockMvc.perform(MockMvcRequestBuilders.post("/intervention/addIntervention")
	    		.param("idType", "3")
	    		.param("idCitizen", "6")
	...
	@Test
	public void getByStatusOrderByStartdate() throws Exception {
