...
public class AssignRestController {
	...
	public AssignDTO updateAssign(@PathVariable("idAssign") int idAssign, @RequestBody AssignDTO assignDTO) throws AssignExeption, InterventionExeption {	
